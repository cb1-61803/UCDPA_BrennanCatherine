...
ax[1].plot(df_hea["Year"], df_hea["Value"], color='g', marker='o', linestyle='--')
ax[2].plot(df_pop["Year"], df_pop["Value"], color='r', marker='o', linestyle='--')
ax[3].plot(df_watsan["Year"], df_watsan["Value"], color='c', marker='o', linestyle='--')
ax[4].plot(df_gov["Year"], df_gov["Value"], color='y', marker='o', linestyle='--')
ax[5].plot(df_infra["Year"], df_infra["Value"], color='m', marker='o', linestyle='--')
